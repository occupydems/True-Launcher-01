...
.method private i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    .line 32
    invoke-static {v0, v1}, LG/s;->k(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    .line 50
    invoke-static {v0, v4}, LG/s;->k(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method private static j(Landroid/os/CancellationSignal;[LO/k$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    .line 9
    :try_start_0
    invoke-virtual {v4}, LO/k$b;->d()Landroid/net/Uri;
...
.method public a(Landroid/content/Context;LF/e$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    .line 46
    invoke-virtual {v3}, LF/e$d;->d()Ljava/lang/String;
    ...
    .line 86
    .line 87
    invoke-direct {p0, p2, p4}, LG/s;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[LO/k$b;I)Landroid/graphics/Typeface;
    ...
    .line 6
    :try_start_0
    invoke-static {p2, p3, p1}, LG/s;->j(Landroid/os/CancellationSignal;[LO/k$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 17
    .line 18
    invoke-direct {p0, p1, p4}, LG/s;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public c(Landroid/content/Context;Landroid/os/CancellationSignal;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    .line 12
    .line 13
    invoke-static {p2, v0, p1}, LG/s;->j(Landroid/os/CancellationSignal;[LO/k$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 36
    check-cast v4, [LO/k$b;

    .line 37
    .line 38
    invoke-static {p2, v4, p1}, LG/s;->j(Landroid/os/CancellationSignal;[LO/k$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 53
    :cond_2
    invoke-direct {p0, v0, p4}, LG/s;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method protected h([LO/k$b;I)LO/k$b;
    .locals 0
